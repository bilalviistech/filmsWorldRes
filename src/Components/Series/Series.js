                    ...
                    <div className="col-lg-9 col-md-9 col-sm-8">
                        ...
                        <div className="row">
                            <div className='col-12 formdiv'>
                                ...
                                <form onSubmit={handleSubmitSeries} id="seriesForm">

                                    <div id="seriesFormDiv">
                                        <div className="row">
                                            <div className="col-lg-5 col-md-4 col-sm-4" id="seriesTitleDiv">
                                            ...
                                            <div className="col-lg-5 col-md-4 col-sm-4" id="seriesThumnailDiv">
                                            ...
                                            <div className="col-lg-2 col-md-2 form-group" id="seriesInputDiv">
                                ...
                                <form onSubmit={handleSubmitSeriesSeason} id="seasonForm">
                                    <div id="seasonFormDiv">
                                        <div className="row">
                                            <div className="col-lg-5 col-md-4" id="seasonSeriestTitle">
                                            ...
                                            <div className="col-lg-5 col-md-4" id="seasonSeries">
                                            ...
                                            <div className="col-lg-2 col-md-2 form-group text-center" id="seasonInputDiv">
                                ...
                                <form onSubmit={handleSubmitSeriesEpisode} id="episodeForm">
                                    <div className="card p-3" style={{ backgroundColor: "#212529", borderRadius: "10px" }}>
                                        ...
                                        <div className="row">
                                            ...
                                            <div className="mb-3 col-lg-12 col-md-6 col-sm-12">
